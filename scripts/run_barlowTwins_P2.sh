...
RESULT_DIR="/data2/users/btwardow/4_tasks_BarlowTwins/P2/l$2"
mkdir -p $RESULT_DIR

CUDA_VISIBLE_DEVICES=$1 PYTHONPATH='.' python main_incremental.py \
--gpu 0 --exp_name barlowTwins_L2 --datasets cifar100_noTrans \
...
--kd_method p2 --approach barlowTwinsFB  --task1_nepochs 500 --dataset2 cifar100 --lambdap2 $2 \
