...
def ss_resnet18(pretrained: bool = False, progress: bool = True, **kwargs):
    return resnet18(pretrained=pretrained, first_conv=False, maxpool1=False, return_all_feature_maps=False)
