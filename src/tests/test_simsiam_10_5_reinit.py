...
FAST_LOCAL_TEST_ARGS = "--gpu 7 --exp_name simsiam --datasets cifar100" \
                       ...
                       " --lr_patience 20 --lr_min 5e-7 --stop_at_task 5 --eval_omni_head --eval_fresh_head --init_after_each_task"
